      ...
      <div class="col-sm-4">
        <div class="card bg-dark">
            <div class="card-header">
                <strong class="card-title mb-3 justify">Account</strong>
            </div>
            <div class="card-body">
                <div class="mx-auto d-block">
                    <img class="rounded-circle mx-auto d-block" src="{{asset('template/images/smile-face.jpg')}}" alt="Card image cap">
                ...
                <div class="card-text text-sm-center">
                    <a href="#"><i class="fa fa-facebook pr-1"></i>FB</a>
